...
const createIncompleteList = (text) => {
  ...
  compleateButton.addEventListener("click", () => {
    ...
    deleteFormIncompleteList(compleateButton.parentNode);
    ...
    backButton.addEventListener("click", () => {
      ...
      const deleteTargetr = backButton.parentNode;
      document.getElementById("complete-list").removeChild(deleteTargetr);
